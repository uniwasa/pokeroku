...
abstract class $MoveCopyWith<$Res> {
  ...
  $Res call(
      {int id,
      String identifier,
      @JsonKey(name: 'version_group_id') int versionGroupId,
      @JsonKey(name: 'pokemon_move_method_id') int pokemonMoveMethodId,
      int level,
      int? order,
      int? power,
      int pp,
      ...
      @JsonKey(name: 'damage_class_id') int damageClassId,
