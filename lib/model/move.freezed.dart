    ...
    return _then(_value.copyWith(
      ...
      identifier: identifier == freezed
          ...
          : identifier // ignore: cast_nullable_to_non_nullable
              as String,
      versionGroupId: versionGroupId == freezed
          ? _value.versionGroupId
      ...
      targetId: targetId == freezed
          ...
          : targetId // ignore: cast_nullable_to_non_nullable
              as int,
      damageClassId: damageClassId == freezed
          ? _value.damageClassId
          : damageClassId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$_Move extends _Move with DiagnosticableTreeMixin {
  const _$_Move(
      {required this.id,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Move(id: $id, identifier: $identifier, versionGroupId: $versionGroupId, pokemonMoveMethodId: $pokemonMoveMethodId, level: $level, order: $order, power: $power, pp: $pp, accuracy: $accuracy, priority: $priority, targetId: $targetId, damageClassId: $damageClassId, effectChance: $effectChance, nameJp: $nameJp, flavorTextJp: $flavorTextJp, itemIdentifier: $itemIdentifier, damageClassNameJp: $damageClassNameJp, typeId: $typeId, type: $type)';
  }
...
abstract class _Move extends Move {
  const factory _Move(
      ...
      required String damageClassNameJp,
      required int typeId,
      @JsonKey(ignore: true) PokemonType? type}) = _$_Move;
